<script>
  ...
  onMount(() => {
    ...
    const center = form.longitudeLaundry !== null && form.latitudeLaundry !== null
      ? [form.longitudeLaundry, form.latitudeLaundry]
      : defaultCenter;
    console.log(form.longitudeLaundry);
    console.log(form.latitudeLaundry);
    ...
    if (form.longitudeLaundry !== null && form.latitudeLaundry !== null) {
    ...
    map.on('click', (e) => {
      ...
      form.latitudeLaundry = parseFloat(coords.lat.toFixed(6));
      form.longitudeLaundry = parseFloat(coords.lng.toFixed(6));
...
<div class="popup-overlay" tabindex="0" role="button" aria-label="Close popup" on:click={closePopup} on:keydown={handleKeyDown}>
  <div class="popup" on:click|stopPropagation>
    ...
    <div class="centered-items">
      <Input type="number" placeholder="Kode Pos" bind:value={form.kodePos} />
    </div>
    <div class="centered-items">
