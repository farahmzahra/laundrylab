...
<svelte:head>
	...
	<meta name="description" content="Halaman Kategori Cuci Kering" />
        ...
        {#each allLaundries as laundry}
            <div class="card-info-border">
				<div class="card-row-spaceless">
					<img src={"/uploads/" + laundry.profilPict} class="img-icon-prof" style="margin-right: 10px;" alt="Pict">
					...
					<img src="{line}" class="spacing" alt="Line">
					<div>
